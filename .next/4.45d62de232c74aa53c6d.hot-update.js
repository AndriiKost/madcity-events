...
var AddEvent = function (_Component) {
    ...
    function AddEvent() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = AddEvent.__proto__ || Object.getPrototypeOf(AddEvent)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
            ...
            eventName: '',
            eventPrice: ''
        }, _this.textInputChanged = function (event) {
            var changedName = event.target.value;
            _this.setState({ barName: changedName });
            console.log(_this.state.barName);
        ...
        value: function render() {
            ...
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    ...
                    'Bar Name',
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { type: 'text', onChange: this.textInputChanged, value: this.state.barName, __source: {
                            fileName: _jsxFileName,
                            lineNumber: 32
                        }
                    })
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    ...
                    'Event Name',
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { type: 'text', onChange: this.textInputChanged, __source: {
                            fileName: _jsxFileName,
                            lineNumber: 33
                        }
                    })
...
//# sourceMappingURL=4.45d62de232c74aa53c6d.hot-update.js.map