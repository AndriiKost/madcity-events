...
var AddEvent = function (_Component) {
    ...
    function AddEvent() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = AddEvent.__proto__ || Object.getPrototypeOf(AddEvent)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
            ...
            switch (inputType) {
                case 'barName':
                    _this.setState({ barName: event.target.value });
                    console.log(event.target.value);
                    break;
                case 'eventName':
                    _this.setState({ eventName: input });
                    break;
                case 'eventPrice':
                    _this.setState({ eventPrice: input });
                    break;
            }
        ...
        value: function render() {
            ...
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    ...
                    'Bar Name',
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { type: 'text', onChange: function onChange() {
                            return _this2.textInputChanged('barName');
                        }, __source: {
                            fileName: _jsxFileName,
                            lineNumber: 45
                        }
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    ...
                    'Event Name',
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { type: 'text', onChange: function onChange() {
                            return _this2.textInputChanged('eventName');
                        }, __source: {
                            fileName: _jsxFileName,
                            lineNumber: 46
                        }
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    ...
                    'Event Attendance',
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { type: 'text', onChange: function onChange() {
                            return _this2.textInputChanged('eventPrice');
                        }, __source: {
                            fileName: _jsxFileName,
                            lineNumber: 47
                        }
...
//# sourceMappingURL=4.7e37e17373bb2368a8d5.hot-update.js.map